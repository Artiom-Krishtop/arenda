...
<form id="<?=$arResult["FORM_ID"]?>" name="<?=$arResult["FORM_ID"]?>" action="<?=$arParams['URL_CUR_PAGE']?>" method="post" enctype="multipart/form-data" autocomplete="off" class="help-form">
