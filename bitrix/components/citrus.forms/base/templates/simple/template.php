...
<?
$formWrapperClass = array();
if (strlen($arParams['FORM_CLASS'])) $formWrapperClass[] = $arParams['FORM_CLASS'];
if ('POPUP' == $arParams['FORM_PLACE_MODE']) $formWrapperClass[] = 'mfp-hide white-popup-block';
if ($arParams['FORM_MOD']) $formWrapperClass[] = 'citrus-form-mod--'.strtolower($arParams['FORM_MOD']);
?>

<div id="ajax_form_<?= $arResult["FORM_ID"] ?>" class="<?=implode(' ', $formWrapperClass)?>">
		...
		<div class="citrus-form__footer">
			...
			*/?>
			...
			<?if($arParams["AGREEMENT_LINK"]  &&
				($arParams['AGREEMENT_POSITION'] === 'BEFORE_BUTTON') ):?>
				<div class="form-group agree-block">
					<div class="agree-block__text">
						<?= Loc::getMessage(
							"CITRUS_FORM_AGREEMENT_MESSAGE",
							array("#LINK#" => $arParams["AGREEMENT_LINK"], "#BUTTON_TITLE#" => $arParams['BUTTON_TITLE'])
						) ?>
					</div>
				</div>
			<?endif;?>
			...
			<?
			$buttonWrapperClass = ['form-group', 'form-group-btn'];
			$isButtonWithAgreement = $arParams["AGREEMENT_LINK"] &&
				($arParams["BUTTON_POSITION"] === 'RIGHT' || $arParams["BUTTON_POSITION"] === 'LEFT');
			if ($isButtonWithAgreement) $buttonWrapperClass[] = '_with-agreement';
			?>
			<div class="<?=implode(' ', $buttonWrapperClass)?><?=($arParams["BUTTON_POSITION"] == 'CENTER') ? ' btn_center' : ''?>">
				<div class="    input-container button-position-<?=strtolower($arParams["BUTTON_POSITION"])?>">
					<?if($arParams["AGREEMENT_LINK"] && $arParams["BUTTON_POSITION"] === "RIGHT"):?>
						<div class="agree-block__text">
							<?= Loc::getMessage(
								"CITRUS_FORM_AGREEMENT_MESSAGE",
								array("#LINK#" => $arParams["AGREEMENT_LINK"], "#BUTTON_TITLE#" => $arParams['BUTTON_TITLE'])
					...
					<?if($arParams["AGREEMENT_LINK"] && $arParams["BUTTON_POSITION"] === "LEFT"):?>
						<div class="agree-block__text">
							<?= Loc::getMessage(
								"CITRUS_FORM_AGREEMENT_MESSAGE",
								array("#LINK#" => $arParams["AGREEMENT_LINK"], "#BUTTON_TITLE#" => $arParams['BUTTON_TITLE'])
			...
			<?if($arParams["AGREEMENT_LINK"] &&
				( $arParams["BUTTON_POSITION"] == 'CENTER' ||
					$arParams["BUTTON_POSITION"] === 'JUSTIFY') ):?>
				<div class="form-group agree-block">
					<div class="agree-block__text">
						<?= Loc::getMessage(
							"CITRUS_FORM_AGREEMENT_MESSAGE",
