...
if (0 < $elementId && 'Y' == $arParams['DETAIL_SHOW_SIMILAR_OFFERS'])
{
	...
	$offer = \travelsoft\stores\Offer::getById($elementId);

	if(!empty($offer)) {
		$seeAlsoFilter['PROPERTY_CITY'] = $offer['PROPERTIES']['CITY']['VALUE'];
		$seeAlsoFilter['PROPERTY_COUNTRY'] = $offer['PROPERTIES']['COUNTRY']['VALUE'];
		$seeAlsoFilter['PROPERTY_CITY_AREA'] = $offer['PROPERTIES']['CITY_AREA']['VALUE'];
	}
