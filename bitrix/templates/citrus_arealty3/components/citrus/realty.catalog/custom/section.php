        ...
        foreach ($currentSection["UF_SORT_FIELDS"] as $propertyId) {
            switch ($propertyId){
                ...
                case IblockPropertyList::DATE_CREATE:
                    $arReturn["DATE_CREATE"] = $iblockFields["DATE_CREATE"]["NAME"];
                    break;
                default:
...
elseif ($obCache->StartDataCache())
{
    ...
    {
        $dbRes = CIBlockSection::GetList(array(), $arFilter, false, array("ID", "NAME", "UF_TYPE","UF_SORT_FIELDS"));
...
?><?$citrusSort = $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "VIEW_DEFAULT" => "LIST",//strtoupper($currentSection["UF_TYPE_XML_ID"]),
...
<? $intSectionID = $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "VIEW_TEMPLATE" => "catalog_" . strtolower($citrusSort["VIEW"]) . '_custom',
    ),
    $component
); ?>
<?php
