    ...
    <div class="slider__item" id="<?= $areaId?>">
        ...
        <div class="slider__info">
            ...
            <div class="slider__btns">
                <button class="slider__btn account-content__btn js-edit-announcements" data-url="/account/announcements/action/?CODE=<?= $actualItem['ID']?>"><?= GetMessage('PA_EDIT_BTN')?></button>
                <button class="slider__btn js-remove-announcements" data-url="/ajax/delete_announcements.php?ID=<?= $actualItem['ID'];?>"><?= GetMessage('PA_REMOVE_BTN')?></button>
            </div>
        </div>
    </div>  
<?}?>