...
$APPLICATION->SetPageProperty("description",
	"Сайт агентства недвижимости Агентство недвижимости. Продажа квартир и комнат, аренда коммерческой недвижимости, помощь в получении ипотеки. Юридическое сопровождение сделок.");
?>
...
<?$APPLICATION->IncludeComponent("citrus.core:include", ".default", array(
