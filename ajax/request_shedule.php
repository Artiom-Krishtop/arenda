...
$APPLICATION->SetTitle("Записаться на просмотр");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FIELDS" => array(
			...
			"PROPERTY_RENT_COMPANY_MAIL" => array(
				"TITLE" => "Почта арендодателя",
				"IS_REQUIRED" => "Y",
				"HIDE_FIELD" => "Y",
				"ORIGINAL_TITLE" => "[170] Email арендодателя",
				"DEFAULT" => htmlspecialchars(trim($_REQUEST['RENT_MAIL'])),
			),
		),
		"FORM_ID" => "citrus_realty_request_shedule",
		"FORM_STYLE" => "WHITE",
		"FORM_TITLE" => "",
		"IBLOCK_ID" => "",
		...
		"MAIL_EVENT" => "CITRUS_REALTY_REQUEST_SHEDULE",
