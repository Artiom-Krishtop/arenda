        ...
        <section class="account-content">
            <section class="account-content__inner account-content__inner-visible">
                <div class="account-content__account">
                    <div class="account-content__account-info">
                        <h1 class="account-content__title"><? $APPLICATION->IncludeFile(SITE_DIR . 'include/personal/hello.php', array(), array('MODE' => 'html', 'NAME' => 'Редактировать текст приветствия'))?></h1>
                    </div>
                    <p class="account-content__account-rules">
                        <? $APPLICATION->IncludeFile(SITE_DIR . 'include/personal/notice.php', array(), array('MODE' => 'html', 'NAME' => 'Редактировать текст приветствия'))?>
                    </p>
                </div>
