...
<div class="container-account">
    <div class="account">
        ...
        if(\ITG\Custom\Favourites::getCount() > 0){
            global $arrFavouritesFilter;

            $arrFavouritesFilter = array("ID" => array_keys(\ITG\Custom\Favourites::getList()));
