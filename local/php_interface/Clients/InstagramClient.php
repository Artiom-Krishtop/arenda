...
class InstagramClient{
    ...
    public function addInstagramPost(){
        $data = '';

        $httpClient = new HttpClient();
        $data = $httpClient->post(self::URL_INSTAGRAM_API . '/media/', array(
            'access_token' => 'IGQVJWOTc3QzVjYlFMU1NOd3lreFliR0pMcjEybHk4bE9EUTFfdkYwdEw5UGpoVHc5aTducF8yT3djYVQzcWRPRFgtVjNxdlM2dUlYd3hLOXRJQ3MyOUZAyc181NDhqS1NPWGwwOHBhS0psaVd0VGFpNAZDZD',
            'image_url' => 'https://arenda-pom.itg-soft.by/upload/resize_cache/iblock/df3/600_600_1/df3dfa9eab75fd33cc1fffe178974b63.jpg'
        )); 
