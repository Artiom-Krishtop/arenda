...
<section class="filter citrus-sf-wrapper">
	<form
            ...
            action="<?if(isset($arParams["FORM_ACTION"]) && !empty($arParams["FORM_ACTION"])):?><?=$arParams["FORM_ACTION"]?><?else:?><? echo $arResult["FORM_ACTION"] ?><?endif?>"
            method="get"
    ...
    >
		...
		<div class="citrus-sf__button-block">
			<button type="submit" class="citrus-sf__button _submit" id="set_filter" name="set_filter">
                ...
                <span <?if(isset($arParams["FORM_ACTION"]) && !empty($arParams["FORM_ACTION"])):?>style="display: none" <?endif?> class="citrus-sf__button__additional-label" id="modef_num"><?=(int)$arResult["ELEMENT_COUNT"]?></span>
            </button>
